...
namespace DECORATOR
{
    public class CodeBuilder
        //: CodeBuilder cannot be inherited
    {
        // Delegated members with reSharper, we end up with a decorator which means we are having everything a strinbuilder has but not really
        // stringbuilder have a fluent interface it returns a stringbuilder
        // we want to return a codebuilder

        // string replace stringbuilder to code builder 
        ...
        // Now we can customize the CodeBuilder because is a StringBuilder plus something more
        ...
        // generate all the delegate members
